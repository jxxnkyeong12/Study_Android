...
public class MainActivity extends AppCompatActivity {
    Button btn_inflate, btn_test; // 레이아웃 인플레이션( 자바<->xml) 연결이 되고나서 초기화를 시킬수있다 (디자인에 있는 위젯을 연결 findViewById )
       ...
       /* inflater.inflate(R.layout.main_sub1 , linear , true);*/
        ...
        btn_inflate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                inflater.inflate(R.layout.main_sub1 , linear , true); //지금 붙일건지?
